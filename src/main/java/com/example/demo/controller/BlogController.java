...
@Controller
@ControllerAdvice
@SessionAttributes("userId") // 세션 속성 관리
public class BlogController {
    ...
    public String board_list(Model model, @RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "") String keyword, @SessionAttribute("userId") String userId) { // 세션에서 userId 가져오기
